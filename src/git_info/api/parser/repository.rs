...
impl Parser {
    pub fn parse_git_repositories(
        ...
        let repos = json_array
            ...
            .fold(GitRepositories::new(), |repsoitories, repo_str| {
                ...
                repsoitories.add_repository(repo);
  ...
  fn parse_git_repository_from_value(value: &serde_json::Value, url: &str) -> Result<GitRepository, ApiError> {
  ...
  Ok(GitRepository::new(name.to_string(), description.to_string()))
  }
}
